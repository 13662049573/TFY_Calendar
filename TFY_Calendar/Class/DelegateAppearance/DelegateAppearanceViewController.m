...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.fillDefaultColors = @{@"2019/11/28":[UIColor purpleColor],
                                     ...
                                     @"2019/11/31":[UIColor yellowColor],
