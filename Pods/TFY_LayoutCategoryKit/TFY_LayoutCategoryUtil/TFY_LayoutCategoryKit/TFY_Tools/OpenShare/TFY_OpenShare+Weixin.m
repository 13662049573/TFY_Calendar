...
@implementation TFY_OpenShare (Weixin)
 ...
 *  @return 需要打开的url
 */
+(NSString*)genWeixinShareUrl:(TFY_OSMessage*)msg to:(int)shareTo{
    ...
    switch (msg.multimediaType) {
        ...
        case TFYOSMultimediaTypeFile:
            ...
            dic[@"title"] = msg.title;
            break;
        case TFYOSMultimediaTypeMiniApp:
            dic[@"objectType"] = @"36";
            dic[@"title"] = msg.title;
            dic[@"thumbData"] = msg.thumbnail? [self dataWithImage:msg.thumbnail] : [self dataWithImage:msg.image scale:CGSizeMake(100, 100)];
