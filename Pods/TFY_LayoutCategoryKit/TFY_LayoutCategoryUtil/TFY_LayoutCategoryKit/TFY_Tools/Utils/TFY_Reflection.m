...
@implementation TFY_Reflection

+ (TFYReflectionResults)performWithTarget:(id)target selectorStringAndParameter:(NSString *)selString, ...
{
    va_list params;
    va_start(params, selString);
    TFYReflectionResults result = [self performWithTarget:target returnValue:NULL selectorString:selString parameter:params];
    va_end(params);
    return result;
}

+ (TFYReflectionResults)performWithTarget:(id)target returnValue:(void *)returnValue selectorStringAndParameter:(NSString *)selString, ...
{
    va_list params;
    va_start(params, selString);
    TFYReflectionResults result = [self performWithTarget:target returnValue:returnValue selectorString:selString parameter:params];
    va_end(params);
    return result;
}

+ (TFYReflectionResults)performWithTarget:(id)target returnValue:(void *)returnValue selectorString:(NSString *)selString parameter:(va_list)params
{
    if (target == nil)
    {
        return TFYReflectionResultsTarget;
    }
    
    if ([selString length] == 0)
    {
        return TFYReflectionResultsSelector;
    }
    ...
    if (signature != nil)
    {
        ...
        return TFYReflectionResultsSuccessful;
    }
    
    return TFYReflectionResultsError;
}
