...
TFY_PROPERTY_CHAIN_READONLY TFY_DatePickerViewChainModel * (^ preferredDatePickerStyle) (UIDatePickerStyle) API_AVAILABLE(ios(13.4));
TFY_PROPERTY_CHAIN_READONLY TFY_DatePickerViewChainModel * (^ roundsToMinuteInterval) (BOOL) API_AVAILABLE(ios(15.0));
