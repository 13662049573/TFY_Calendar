...
const NSUInteger TFY_IndexViewInvalidSection = NSUIntegerMax - 1;
const NSInteger TFY_IndexViewSearchSection = -1;

static inline UIColor *TFY_GetColor(CGFloat red, CGFloat green, CGFloat blue, CGFloat alpha)
{
    return [UIColor colorWithRed:red/255.0 green:green/255.0 blue:blue/255.0 alpha:alpha];
}

@interface TFY_IndexViewConfiguration ()
@property (nonatomic, assign) TFY_IndexViewStyle indexViewStyle;  // 索引元素之间间隔距离
@end

@implementation TFY_IndexViewConfiguration

@synthesize indexViewStyle = _indexViewStyle;

+ (instancetype)configuration
{
    return [self configurationWithIndexViewStyle:TFY_IndexViewStyleDefault];
}
...
+ (instancetype)configurationWithIndexViewStyle:(TFY_IndexViewStyle)indexViewStyle
{
    ...
    switch (indexViewStyle) {
        ...
        {
            indicatorBackgroundColor = TFY_GetColor(200, 200, 200, 1);
        ...
        {
            indicatorBackgroundColor = TFY_GetColor(200, 200, 200, 0.8);
            indicatorTextColor = [UIColor whiteColor];
    ...
    return [self configurationWithIndexViewStyle:indexViewStyle
                ...
                indexItemSelectedBackgroundColor:TFY_GetColor(40, 170, 40, 1)
...
{
    TFY_IndexViewConfiguration *configuration = [self new];
