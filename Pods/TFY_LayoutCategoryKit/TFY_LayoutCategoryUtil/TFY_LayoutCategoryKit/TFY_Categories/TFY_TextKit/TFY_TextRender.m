...
- (void)addLayoutManager {
    TFY_LayoutManager *layoutManager = [[TFY_LayoutManager alloc]init];
...
- (void)setHighlightBackgroudRadius:(CGFloat)highlightBackgroudRadius {
    ...
    if ([_layoutManager isKindOfClass:[TFY_LayoutManager class]]) {
        ((TFY_LayoutManager *)_layoutManager).highlightBackgroudRadius = highlightBackgroudRadius;
    }
}
...
- (void)setHighlightBackgroudInset:(UIEdgeInsets)highlightBackgroudInset {
    ...
    if ([_layoutManager isKindOfClass:[TFY_LayoutManager class]]) {
        ((TFY_LayoutManager *)_layoutManager).highlightBackgroudInset = highlightBackgroudInset;
    }
}
...
@implementation TFY_TextRender (Rendering)
...
- (void)setTextHighlight:(TFY_TextHighlight *)textHighlight range:(NSRange)range {
    ...
    if ([_layoutManager isKindOfClass:[TFY_LayoutManager class]]) {
        TFY_LayoutManager *layoutManager = (TFY_LayoutManager *)_layoutManager;
